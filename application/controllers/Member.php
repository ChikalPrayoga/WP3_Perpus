    ...
    { 
        ...
        { 
            ...
            { 
                ...
                { 
                    // jika cara ini tidak bisa upload gambar bisa di ganti 
                    // untuk $gambar_lama=$data['userdata'][image'];
                    ...
                    $this->db->update('user');
                        ...
                        $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-message" role="alert">Gambar Gagal Diupload.</div>'); 
                        redirect(base_url().'member/myProfil');
                    }
                }
            $this->db->set('nama', $nama); 
            $this->db->where('email', $email); 
